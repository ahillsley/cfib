...
def create_zarr(
    ...
    for t in tif_path_list:
        ...
        if t.suffix != ".tif":
            continue
        row = t.name[0]
        col = t.name.split("--")[0][1:]
        fov = t.name.split("--")[2][1:]
        channel = t.name.split("--")[-1].split(" ")[0].split(".")[0]
    ...
    for key, val in tqdm(position_dict.items()):
        ...
        output_pos.create_image(
            name="0", data=tif_array_ome, chunks=(1, 1, 1, 1024, 1344)
        )
...
if __name__ == "__main__":
    dir_path = "/Users/alexander.hillsley/Documents/CZBiohub/projects/cfib/data/pilot_1"
    output_path = "/Users/alexander.hillsley/Documents/CZBiohub/projects/cfib/data/analysis/pilot_1.zarr"
